...
lista = ["1)Presentación por pantalla ", "2)Variable","3)Conversion" ,"4)Operaciones Matematicas", "5)Concatenación",
         ...
         "11)Condicional if-else-elif", "12)Funciones", "13)Operadores Ternario", "14)IF con tupla", "15)Función Range",
         "16)Bucle for", "17)Factorial de un número", "18)Bucle While", "19)Sentencias", "20)Generador yiel",
         "21)Generador yiel from", "22)Excepciones", "23)Sentencia Raise", "24)Importaciones","25)Prueba Paquetes",
         "26)Programación orientada a objeto", "27)Constructor en clases","28)Encapsulamiento de variable",
         "29)Encapsulamiento de metodos en clases","30)Métodos Accesores","31)Método de clase __STR__","32)Herencia"
         ,"33)Método Super()","34)Principio de Sustitución","35)Herencia Multiple","36)Polimorfismo","37)Relaciones entre clases",
         "38)Salir"]
opcion = ""
while opcion != "38":
    os.system("cls")
